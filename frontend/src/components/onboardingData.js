...
export const travelerTypes = [
  { id: 'men', label: 'Men', desc: 'Safety‑first solo travel tailored for you.', emoji: '🧔', glow: 'hover:border-sky-500/50 hover:shadow-sky-500/15', active: 'border-sky-500/70 bg-sky-500/10 shadow-sky-500/20' },
  { id: 'women', label: 'Women', desc: 'Safety‑first solo travel tailored for you.', emoji: '👩', glow: 'hover:border-emerald-500/50 hover:shadow-emerald-500/15', active: 'border-emerald-500/70 bg-emerald-500/10 shadow-emerald-500/20' },
  { id: 'family', label: 'Family', desc: 'Safety‑first solo travel tailored for you.', emoji: '👨‍👩‍👧', glow: 'hover:border-violet-500/50 hover:shadow-violet-500/15', active: 'border-violet-500/70 bg-violet-500/10 shadow-violet-500/20' },
];
